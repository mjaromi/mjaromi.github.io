    ...
    Prism = (function (b) {
            ...
            a = {
                ...
                languages: {
                    ...
                    DFS: function i(f, g, j, c) {
                        ...
                        (c = c || {}), (e = a.util.objId);
                        for (d in f)
                            f.hasOwnProperty(d) && (g.call(f, d, f[d], j || d), (b = f[d]), (h = a.util.type(b)), "Object" !== h || c[e(b)] ? "Array" !== h || c[e(b)] || ((c[e(b)] = !0), i(b, g, d, c)) : ((c[e(b)] = !0), i(b, g, null, c)));
                    },
                },
                plugins: {},
        ...
        return (
            ...
            !a.manual &&
                ...
                "loading" === i || ("interactive" === i && d && d.defer) ? document.addEventListener("DOMContentLoaded", g) : window.requestAnimationFrame ? window.requestAnimationFrame(g) : window.setTimeout(g, 16)),
            a
        );
    })(_self);
"undefined" != typeof module && module.exports && (module.exports = Prism),
    ...
    !(function (a) {
        ...
        (a.languages.css = {
            ...
            url: { pattern: RegExp("\\burl\\((?:" + b.source + "|(?:[^\\\\\r\n()\"']|\\\\[^])*)\\)", "i"), greedy: !0, inside: { function: /^url/i, punctuation: /^\(|\)$/, string: { pattern: RegExp("^" + b.source + "$"), alias: "url" } } },
                    ...
                    "attr-value",
                    {
                        "style-attr": {
                            ...
                            inside: {
                                "attr-value": {
                                    pattern: /=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,
                                    inside: { style: { pattern: /(["'])[\s\S]+(?=["']$)/, lookbehind: !0, alias: "language-css", inside: a.languages.css }, punctuation: [{ pattern: /^=/, alias: "attr-equals" }, /"|'/] },
                                },
                                "attr-name": /^style/i,
                            },
                        },
    ...
    !(function (a) {
        var b =
            ...
            c = {
                ...
                variable: [
                    ...
                    { pattern: /\$\{[^}]+\}/, greedy: !0, inside: { operator: /:[-=?+]?|[!\/]|##?|%%?|\^\^?|,,?/, punctuation: /[\[\]]/, environment: { pattern: RegExp("(\\{)" + b), lookbehind: !0, alias: "constant" } } },
                    /\$(?:\w+|[#?*!@$])/,
                ],
        ...
        (a.languages.bash = {
            ...
            "assign-left": { pattern: /(^|[\s;|&]|[<>]\()\w+(?=\+?=)/, inside: { environment: { pattern: RegExp("(^|[\\s;|&]|[<>]\\()" + b), lookbehind: !0, alias: "constant" } }, alias: "variable", lookbehind: !0 },
            string: [
        ...
        for (
            f = ["comment", "function-name", "for-or-select", "assign-left", "string", "environment", "function", "keyword", "builtin", "boolean", "file-descriptor", "operator", "punctuation", "number"], g = c.variable[1].inside, d = 0;
            d < f.length;
            d++
        )
    ...
    !(function (a) {
        ...
        (a.languages.coffeescript = a.languages.extend("javascript", {
            ...
            a.languages.insertBefore("coffeescript", "string", {
                "inline-javascript": { pattern: /`(?:\\[\s\S]|[^\\`])*`/, inside: { delimiter: { pattern: /^`|`$/, alias: "punctuation" }, script: { pattern: /[\s\S]+/, alias: "language-javascript", inside: a.languages.javascript } } },
                "multiline-string": [
    ...
    Prism.languages.insertBefore("elixir", "keyword", { module: { pattern: /\b(defmodule\s)[A-Z][\w.\\]+/, lookbehind: !0, alias: "class-name" }, function: { pattern: /\b(defp?\s)[\w.\\]+/, lookbehind: !0 } }),
    ...
    (Prism.languages.erlang = {
        ...
        operator: [/[=\/<>:]=|=[:\/]=|\+\+?|--?|[=*\/!]|\b(?:bnot|div|rem|band|bor|bxor|bsl|bsr|not|and|or|xor|orelse|andalso)\b/, { pattern: /(^|[^<])<(?!<)/, lookbehind: !0 }, { pattern: /(^|[^>])>(?!>)/, lookbehind: !0 }],
        atom: /\b[a-z][\w@]*/,
        punctuation: /[()[\]{}:;,.#|]|<<|>>/,
    }),
    (Prism.languages.git = {
    ...
    !(function (e) {
        var c, f, g, a, d, h, b, i;
        (e.languages.http = {
            "request-line": { pattern: /^(?:POST|GET|PUT|DELETE|OPTIONS|PATCH|TRACE|CONNECT)\s(?:https?:\/\/|\/)\S+\sHTTP\/[0-9.]+/m, inside: { property: /^(?:POST|GET|PUT|DELETE|OPTIONS|PATCH|TRACE|CONNECT)\b/, "attr-name": /:\w+/ } },
    ...
    !(function (a) {
        var b = /\b(?:abstract|assert|boolean|break|byte|case|catch|char|class|const|continue|default|do|double|else|enum|exports|extends|final|finally|float|for|goto|if|implements|import|instanceof|int|interface|long|module|native|new|non-sealed|null|open|opens|package|permits|private|protected|provides|public|record|requires|return|sealed|short|static|strictfp|super|switch|synchronized|this|throw|throws|to|transient|transitive|try|uses|var|void|volatile|while|with|yield)\b/,
            d = "(^|[^\\w.])(?:[a-z]\\w*\\s*\\.\\s*)*(?:[A-Z]\\w*\\s*\\.\\s*)*",
            c = { pattern: RegExp(d + "[A-Z](?:[\\d_A-Z]*[a-z]\\w*)?\\b"), lookbehind: !0, inside: { namespace: { pattern: /^[a-z]\w*(?:\s*\.\s*[a-z]\w*)*(?:\s*\.)?/, inside: { punctuation: /\./ } }, punctuation: /\./ } };
            ...
            a.languages.insertBefore("javadoc", "keyword", {
                ...
                "code-section": [
                    ...
                    },
                    {
                        ...
                        lookbehind: !0,
                        inside: { line: { pattern: b, lookbehind: !0, inside: { tag: a.languages.markup.tag, entity: a.languages.markup.entity, code: { pattern: /.+/, inside: a.languages.java, alias: "language-java" } } } },
                    },
                ],
    ...
    !(function (a) {
        ...
        a.languages.insertBefore("javascript", "function-variable", {
            "method-variable": { pattern: RegExp("(\\.\\s*)" + a.languages.javascript["function-variable"].pattern.source), lookbehind: !0, alias: ["function-variable", "method", "function", "property-access"] },
        }),
            ...
            a.languages.insertBefore("javascript", "keyword", {
                imports: { pattern: d("(\\bimport\\b\\s*)(?:<ID>(?:\\s*,\\s*(?:\\*\\s*as\\s+<ID>|\\{[^{}]*\\}))?|\\*\\s*as\\s+<ID>|\\{[^{}]*\\})(?=\\s*\\bfrom\\b)"), lookbehind: !0, inside: a.languages.javascript },
        ...
        for (e = ["function", "function-variable", "method", "method-variable", "property-access"], c = 0; c < e.length; c++)
            (f = e[c]), (b = a.languages.javascript[f]), "RegExp" === a.util.type(b) && (b = a.languages.javascript[f] = { pattern: b }), (g = b.inside || {}), ((b.inside = g)["maybe-class-name"] = /^[A-Z][\s\S]*/);
    })(Prism),
    ...
    !(function (d) {
        ...
        (b.lambda.inside.arguments = g), (b.defun.inside.arguments = d.util.clone(g)), (b.defun.inside.arguments.inside.sublist = g), (d.languages.lisp = b), (d.languages.elisp = b), (d.languages.emacs = b), (d.languages["emacs-lisp"] = b);
    })(Prism),
        ...
        var b = [
            {
                pattern: /(^|[^\\])\$\{(?:[^'"{}]|\{[^}]*\}|(["'])(?:(?!\2)[^\\]|\\[\s\S])*\2)+\}/,
                lookbehind: !0,
                inside: { "short-variable": { pattern: /(^\$\{)(?!\w+\()(?:::)?\w+(?:::\w+)*/, lookbehind: !0, alias: "variable", inside: { punctuation: /::/ } }, delimiter: { pattern: /^\$/, alias: "variable" }, rest: a.languages.puppet },
            },
    ...
    (Prism.languages.purescript = Prism.languages.extend("haskell", {
        ...
        "import-statement": { pattern: /(^\s*)import\s+[A-Z][\w']*(?:\.[A-Z][\w']*)*(?:\s+as\s+[A-Z][\w']*(?:\.[A-Z][\w']*)*)?(?:\s+hiding\b)?/m, lookbehind: !0, inside: { keyword: /\b(?:import|as|hiding)\b/ } },
    ...
    !(function (a) {
        ...
        (a.languages.jsx = a.languages.extend("markup", d)),
            (a.languages.jsx.tag.pattern = /<\/?(?:[\w.:-]+(?:\s+(?:[\w.:$-]+(?:=(?:"(?:\\[^]|[^\\"])*"|'(?:\\[^]|[^\\'])*'|[^\s{'">=]+|\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])+\}))?|\{\s*\.{3}\s*[a-z_$][\w$]*(?:\.[a-z_$][\w$]*)*\s*\}))*\s*\/?)?>/i),
            ...
            a.languages.insertBefore("inside", "attr-name", { spread: { pattern: /\{\s*\.{3}\s*[a-z_$][\w$]*(?:\.[a-z_$][\w$]*)*\s*\}/, inside: { punctuation: /\.{3}|[{}.]/, "attr-value": /\w+/ } } }, a.languages.jsx.tag),
            a.languages.insertBefore(
                "inside",
                "attr-value",
                { script: { pattern: /=(?:\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])+\})/i, inside: { "script-punctuation": { pattern: /^=(?={)/, alias: "punctuation" }, rest: a.languages.jsx }, alias: "language-javascript" } },
                a.languages.jsx.tag
            ),
            (b = function (a) {
    ...
    !(function (a) {
        ...
        a.languages.insertBefore("sass", "property", {
            ...
            a.languages.insertBefore("sass", "punctuation", { selector: { pattern: /([ \t]*)\S(?:,[^,\r\n]+|[^,\r\n]*)(?:,[^,\r\n]+)*(?:,(?:\r?\n|\r)\1[ \t]+\S(?:,[^,\r\n]+|[^,\r\n]*)(?:,[^,\r\n]+)*)*/, lookbehind: !0 } });
    })(Prism),
    ...
    !(function (e) {
        var b = /[*&][^\s[\]{},]+/,
            ...
            g = "(?:[^\\s\\x00-\\x08\\x0e-\\x1f!\"#%&'*,\\-:>?@[\\]`{|}\\x7f-\\x84\\x86-\\x9f\\ud800-\\udfff\\ufffe\\uffff]|[?:-]<PLAIN>)(?:[ 	]*(?:(?![#:])<PLAIN>|:<PLAIN>))*".replace(/<PLAIN>/g, function () {
        ...
        (e.languages.yaml = {
            ...
            datetime: { pattern: a("\\d{4}-\\d\\d?-\\d\\d?(?:[tT]|[ 	]+)\\d\\d?:\\d{2}:\\d{2}(?:\\.\\d*)?(?:[ 	]*(?:Z|[-+]\\d\\d?(?::\\d{2})?))?|\\d{4}-\\d{2}-\\d{2}|\\d\\d?:\\d{2}(?::\\d{2}(?:\\.\\d*)?)?"), lookbehind: !0, alias: "number" },
            ...
            Prism.hooks.add("before-sanity-check", function (c) {
                ...
                Prism.hooks.add("complete", function g(c) {
                    ...
                    a &&
                        ...
                        (clearTimeout(f), (i = Prism.plugins.lineNumbers), (j = c.plugins && c.plugins.lineNumbers), b(a, "line-numbers") && i && !j ? Prism.hooks.add("line-numbers", g) : (d(a, e)(), (f = setTimeout(h, 1))));
                }),
                ...
                (s.forEach(function (f) {
                    ...
                    d.push(function () {
                        ...
                        j && Prism.plugins.lineNumbers
                            ...
                            : d.push(function () {
                                  a.setAttribute("data-start", String(b)), b < e && a.setAttribute("data-end", String(e)), (a.style.top = (b - r - 1) * q + n + "px"), (a.textContent = new Array(e - b + 2).join(" \n"));
                              }),
                        d.push(function () {
                            p.appendChild(a);
                        });
    ...
    !(function () {
        ...
        "undefined" != typeof self &&
            ...
            (d = Prism.plugins.toolbar.registerButton = function (d, c) {
                var e;
                (e =
                    "function" == typeof c
                        ? c
            ...
            (e = Prism.plugins.toolbar.hook = function (f) {
            ...
            d("label", function (e) {
                ...
                if (a && /pre/i.test(a.nodeName) && a.hasAttribute("data-label")) {
                    ...
                    return c ? (b = c.content) : (a.hasAttribute("data-url") ? ((b = document.createElement("a")).href = a.getAttribute("data-url")) : (b = document.createElement("span")), (b.textContent = d)), b;
                }
            }),
